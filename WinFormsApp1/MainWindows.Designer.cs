namespace WinFormsApp1
{
    partial class MainWindows
    {
        ...
        private void InitializeComponent()
        {
            ...
            tabpage_General = new TabPage();
            button_Vlan = new Button();
            label_Vlan = new Label();
            textBox_Vlan = new TextBox();
            tabPage_Vlan = new TabPage();
            ...
            tabControl_Parametre.Controls.Add(tabpage_General);
            tabControl_Parametre.Controls.Add(tabPage_Vlan);
            ...
            // tabpage_General
            // 
            tabpage_General.Controls.Add(label_Hostname);
            tabpage_General.Controls.Add(button_Hostname);
            tabpage_General.Controls.Add(textbox_Hostname);
            tabpage_General.Location = new Point(4, 34);
            tabpage_General.Name = "tabpage_General";
            tabpage_General.Padding = new Padding(3);
            tabpage_General.Size = new Size(472, 245);
            ...
            // button_Vlan
            // 
            button_Vlan.Location = new Point(356, 38);
            button_Vlan.Margin = new Padding(4);
            button_Vlan.Name = "button_Vlan";
            button_Vlan.Size = new Size(51, 36);
            button_Vlan.TabIndex = 13;
            button_Vlan.Text = "Press";
            button_Vlan.UseVisualStyleBackColor = true;
            // 
            // label_Vlan
            // 
            label_Vlan.AutoSize = true;
            label_Vlan.Location = new Point(87, 44);
            label_Vlan.Margin = new Padding(2, 0, 2, 0);
            label_Vlan.Name = "label_Vlan";
            label_Vlan.Size = new Size(57, 25);
            label_Vlan.TabIndex = 11;
            label_Vlan.Text = "VLAN";
            // 
            // textBox_Vlan
            // 
            textBox_Vlan.Location = new Point(159, 41);
            textBox_Vlan.Margin = new Padding(2);
            textBox_Vlan.Name = "textBox_Vlan";
            textBox_Vlan.Size = new Size(188, 31);
            textBox_Vlan.TabIndex = 12;
            // 
            // tabPage_Vlan
            // 
            tabPage_Vlan.Controls.Add(button_Vlan);
            tabPage_Vlan.Controls.Add(label_Vlan);
            tabPage_Vlan.Controls.Add(textBox_Vlan);
            tabPage_Vlan.Location = new Point(4, 34);
            tabPage_Vlan.Name = "tabPage_Vlan";
            tabPage_Vlan.Padding = new Padding(3);
            tabPage_Vlan.Size = new Size(472, 245);
            tabPage_Vlan.TabIndex = 1;
            tabPage_Vlan.Text = "VLAN";
            tabPage_Vlan.UseVisualStyleBackColor = true;
            // 
            // button_Hostname
            // 
            button_Hostname.Location = new Point(371, 36);
            ...
            label_Hostname.Location = new Point(59, 41);
            ...
            // textbox_Hostname
            // 
            textbox_Hostname.Location = new Point(170, 38);
            ...
            tabPage_Vlan.ResumeLayout(false);
            tabPage_Vlan.PerformLayout();
        ...
        private Button button_Vlan;
        private Label label_Vlan;
        private TextBox textBox_Vlan;
        private TabPage tabPage_Vlan;
